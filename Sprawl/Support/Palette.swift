...
enum Palette {
    ...
    /// 16 bright pastels (a 4×4 grid) for sticky notes and free text.
    static let pastels: [NSColor] = [
        srgb(0xFF, 0xD9, 0x6B), srgb(0xFF, 0xC1, 0x8C), srgb(0xF7, 0x9E, 0x9E), srgb(0xFF, 0xA8, 0xC4),
        srgb(0xE6, 0xA0, 0xDA), srgb(0xC9, 0xA8, 0xF5), srgb(0xB3, 0xB8, 0xF5), srgb(0x8E, 0xCD, 0xF7),
        srgb(0x8F, 0xD9, 0xE6), srgb(0x8F, 0xE6, 0xC4), srgb(0xA8, 0xE6, 0x8C), srgb(0xCD, 0xE8, 0x9A),
        srgb(0xE8, 0xD7, 0xA0), srgb(0xD9, 0xB3, 0x8C), srgb(0xC0, 0xC4, 0xCF), srgb(0xAA, 0xB0, 0xBF),
    ]
